...
export const TRIVIA_POOL: readonly TriviaQuestion[] = [
  ...
  // ── v6: 세계사 보강 (적대적 검증 통과분) ──────────────────
  {
    id: 'hist-mansa-musa-mali',
    category: '역사',
    question: '여행길에 금을 뿌린 것으로 유명한 만사 무사의 제국은?',
    choices: ['가나 제국', '악숨 왕국', '말리 제국', '짐바브웨 왕국'],
    correctIndex: 2,
    difficulty: 3,
    note: '1324년 여행에서 뿌린 금 때문에 카이로 금값이 내렸다는 이야기가 전한다.',
  },
  {
    id: 'hist-sudan-pyramids',
    category: '역사',
    question: '이집트보다 고대 피라미드가 더 많이 남은 나라는?',
    choices: ['수단', '리비아', '에티오피아', '알제리'],
    correctIndex: 0,
    difficulty: 3,
    note: '쿠시 왕국이 남긴 누비아 피라미드가 200기가 넘는다. 이집트보다 두 배가량 많다.',
  },
  {
    id: 'hist-silk-road-naming',
    category: '역사',
    question: "'실크로드'라는 이름이 처음 붙여진 시기는?",
    choices: ['한나라 때', '로마 제국 때', '몽골 제국 때', '19세기 유럽'],
    correctIndex: 3,
    difficulty: 2,
    note: '1877년 독일 지리학자 리히트호펜이 널리 퍼뜨린 이름. 당대엔 그런 명칭이 없었다.',
  },
  {
    id: 'hist-newton-mint',
    category: '역사',
    question: '뉴턴이 말년에 맡아 위조 화폐범을 쫓던 자리는?',
    choices: ['왕실 주치의', '조폐국장', '대학 총장', '해군 제독'],
    correctIndex: 1,
    difficulty: 2,
    note: '1696년 조폐국 감사관으로 들어가 위조범 수사를 지휘했고 1699년 국장에 올랐다.',
  },
  {
    id: 'hist-inca-quipu',
    category: '역사',
    question: '잉카 제국이 인구와 세금을 기록하는 데 쓴 것은?',
    choices: ['점토판', '파피루스 두루마리', '대나무 조각', '매듭 지은 끈'],
    correctIndex: 3,
    difficulty: 2,
    note: '키푸라 불린 끈 뭉치. 매듭의 위치와 개수로 10진법 숫자를 나타냈다.',
  },
  {
    id: 'hist-tulip-ottoman',
    category: '역사',
    question: '17세기 네덜란드를 뒤흔든 튤립이 전해져 온 곳은?',
    choices: ['남아메리카', '오스만 제국', '인도', '이집트'],
    correctIndex: 1,
    difficulty: 3,
    note: '16세기 중반 오스만 궁정의 재배종이 사절을 통해 유럽에 들어온 것이 시작.',
  },
  {
    id: 'hist-ibn-battuta',
    category: '역사',
    question: '아시아와 아프리카를 29년간 떠돈 중세 여행가는?',
    choices: ['이븐 바투타', '마르코 폴로', '이븐 시나', '알 콰리즈미'],
    correctIndex: 0,
    difficulty: 2,
    note: '1325년 탕헤르를 떠나 오늘날 40개국이 넘는 지역을 돌아다녔다.',
  },
  {
    id: 'hist-tenochtitlan-island',
    category: '역사',
    question: '아즈텍 제국의 수도 테노치티틀란이 세워진 자리는?',
    choices: ['사막 오아시스', '화산 분화구 안', '호수 위 섬', '절벽 위 요새'],
    correctIndex: 2,
    difficulty: 2,
    note: '텍스코코 호수의 섬에 세워졌고, 그 호수를 메운 자리가 지금의 멕시코시티다.',
  },

  // ── v6: 문화 어려움 보강 (적대적 검증 통과분) ──────────────
  {
    id: 'cult-necktie-croatia',
    category: '문화',
    question: '넥타이의 원형을 프랑스에 유행시킨 용병의 출신지는?',
    choices: ['스위스', '크로아티아', '스코틀랜드', '헝가리'],
    correctIndex: 1,
    difficulty: 3,
    note: "17세기 크로아티아 용병의 목수건을 프랑스 궁정이 따라 하며 '크라바트'가 됐다.",
  },
  {
    id: 'cult-jaws-shark',
    category: '문화',
    question: '영화 "죠스"에 상어가 거의 안 나오는 이유는?',
    choices: [
      '원작 소설을 그대로 따라서',
      '검열 기준에 걸려서',
      '기계 상어가 자꾸 고장 나서',
    ...
    correctIndex: 2,
    difficulty: 2,
    note: '바닷물에 기계 상어가 계속 망가져 스필버그가 안 보여주는 쪽으로 선회. 결과는 대성공.',
  },
  {
    id: 'cult-psycho-blood',
    category: '문화',
    question: '영화 "사이코" 샤워 장면에서 피 대신 쓴 것은?',
    choices: ['초콜릿 시럽', '케첩', '붉은 물감', '동물의 피'],
    correctIndex: 0,
    difficulty: 2,
    note: '흑백 필름에선 진짜 피보다 초콜릿 시럽이 훨씬 진하고 걸쭉하게 찍혔다.',
  },
  {
    id: 'cult-boxing-ring',
    category: '문화',
    question: "복싱 경기장이 사각인데 '링'이라 불리는 이유는?",
    choices: ['종을 울려서', '밧줄이 원을 그려서', '둥글게 둘러싼 원에서', '창시자의 이름에서'],
    correctIndex: 2,
    difficulty: 2,
    note: '옛날엔 관중이 둥글게 둘러싼 원 안에서 싸웠다. 사각 링은 1838년부터.',
  },
  {
    id: 'cult-clock-four',
    category: '문화',
    question: '로마 숫자 시계 문자판에서 4를 전통적으로 쓰는 법은?',
    choices: ['IV', 'IIII', 'VI', 'IIV'],
    correctIndex: 1,
    difficulty: 3,
    note: '시계판만은 IIII를 쓰는 관습. 균형·주조틀 절약 등 설이 갈리고 정설은 없다.',
  },
  {
    id: 'cult-golf-dimple',
    category: '문화',
    question: '골프공에 홈(딤플)을 파게 된 계기는?',
    choices: ['무게를 줄이려고', '만들기 쉬워서', '잔디에 잘 서라고', '흠집 난 공이 더 날아가서'],
    correctIndex: 3,
    difficulty: 3,
    note: '19세기 골퍼들이 낡아 흠집 난 공이 새 공보다 멀리 나가는 걸 발견한 데서 시작.',
  },
  {
    id: 'cult-24fps',
    category: '문화',
    question: '영화가 초당 24프레임으로 굳어진 결정적 이유는?',
    choices: [
      '소리를 함께 담으려고',
      '사람 눈의 한계라서',
      '무성영화 때부터 같아서',
    ...
    correctIndex: 0,
    difficulty: 3,
    note: '필름 옆 광학 사운드 트랙이 알아들을 만한 소리를 내는 최저 속도가 24였다.',
  },
  {
    id: 'cult-encore-bis',
    category: '문화',
    question: "프랑스·이탈리아 관객이 '한 번 더'를 청할 때 외치는 말은?",
    choices: ['앙코르', '비스', '다카포', '알레그로'],
    correctIndex: 1,
    difficulty: 3,
    note: '앙코르는 프랑스어지만 정작 프랑스에선 이 구호로 안 쓴다. 전통적으론 라틴어 bis.',
  },
  {
    id: 'cult-mario-mustache',
    category: '문화',
    question: '게임 캐릭터 마리오에게 콧수염이 생긴 이유는?',
    choices: [
      '이탈리아인 느낌 때문',
      '나이 들어 보이게',
      '인기 만화 오마주',
    ...
    correctIndex: 3,
    difficulty: 2,
    note: '미야모토: 입을 그릴 픽셀이 없어 콧수염으로 대신했다. 모자도 머리카락 대신.',
  },
  {
    id: 'cult-ketchup-origin',
    category: '문화',
    question: "'케첩'이라는 말의 어원이 된 원래 소스는?",
    choices: ['토마토 소스', '겨자 소스', '생선 젓갈 소스', '포도 식초'],
    correctIndex: 2,
    difficulty: 2,
    note: '중국 푸젠 지방의 생선 액젓 kê-tsiap. 토마토가 들어간 건 19세기부터.',
  },
] as const;
...
const EXCLUSIVE_GROUPS: Readonly<Record<string, readonly string[]>> = {
  ...
  'cult-film-trivia': ['cult-jaws-shark', 'cult-psycho-blood'],
  ...
  'hist-inca': ['hist-machu-picchu-inca', 'hist-inca-quipu'],
  // 보기는 안 겹치지만 같은 인물/소재라 한 라운드에 둘 다 나오면 김이 빠진다.
  newton: ['sci-newton', 'hist-newton-mint'],
  pyramid: ['world-pyramid-egypt', 'cult-pyramid-builder', 'hist-sudan-pyramids'],
